...
fun void serial() {
     ...
     int valArray[16]; // toda vez que ele entra no Serial ele cria o array para tirar a média  ( isso faz 0 o array) 
...
fun void play() {
    ...
    while (media <= 50) {
        ...
        me.dir()  + "/Sons/concentrar.wav" => Som1.read;
